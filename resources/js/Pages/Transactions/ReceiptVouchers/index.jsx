...
export default function index({ receipt_vouchers, account_details, currencies }) {
    const { props } = usePage();
    const {
        ...
        const timeout = setTimeout(() => {
            if (flatpickerForCreateForm.current) {
                flatpickr(flatpickerForCreateForm.current, {
                    ...
                    onChange: function (selectedDates, dateStr) {
                        if (selectedDates[0]) {
                            setCreateData('receipt_date', dateStr);
                        }
                    },
                });
            }
            ...
            if (flatpickerForEditForm.current) {
                flatpickr(flatpickerForEditForm.current, {
                    ...
                    onChange: function (selectedDates, dateStr) {
                        if (selectedDates[0]) {
                            setEditData('receipt_date', dateStr);
                        }
                    },
                });
            }
    ...
    useEffect(() => {
        const timeout = setTimeout(() => {
            if (createData.received_by === 'bank' && flatpickerForCreateFormChequeDate.current) {
        ...
        return () => clearTimeout(timeout);
    }, [createData.received_by, flatpickerForCreateFormChequeDate.current]);

    useEffect(() => {
        const timeout = setTimeout(() => {
            if (editData.received_by === 'bank' && flatpickerForEditFormChequeDate.current) {
        ...
        return () => clearTimeout(timeout);
    }, [editData.received_by, flatpickerForEditFormChequeDate.current]);
    ...
    useEffect(() => {
        const columns = [
            ...
            { key: 'total_amount', label: 'Amount Received' },
        ];
        ...
        const actions = [
            {
                ...
                onClick: (item) => {
                    ...
                    setEditData('receipt_date', item.receipt_date);
                    setEditData('received_from', item.received_from);
                    setEditData('received_details', item.received_details);
                    setEditData('received_by', item.received_by);
    ...
    const CreateMethod = (e) => {
        ...
        createPost(route('transactions.receipt-vouchers.store'), {
            onSuccess: () => {
                setCreateData('receipt_date', '');
                setCreateData('received_from', '');
                setCreateData('received_details', '');
                setCreateData('received_by', '');
    ...
    const EditMethod = (e) => {
        e.preventDefault();
        editPut(route('transactions.receipt-vouchers.update', editData.id), {
            onSuccess: () => {
                setEditModalOpen(false);
                setEditData('id', '');
                setEditData('receipt_date', '');
                setEditData('received_from', '');
                setEditData('received_details', '');
                setEditData('received_by', '');
    ...
    useEffect(() => {
        if (createData.received_by != '') {
            getRecordByType(createData.received_by);
        }

        if (editData.received_by != '') {
            getRecordByType(editData.received_by);
        }
    }, [createData.received_by, editData.received_by]);
                    ...
                    Content={
                        <>
                            ...
                            <Table
                                ...
                                BulkDeleteRoute={'transactions.receipt-vouchers.destroybyselection'}
                                SingleDeleteRoute={'transactions.receipt-vouchers.destroy'}
                                items={receipt_vouchers}
                                props={props}
                                columns={columns}
                                Search={false}
                                            ...
                                            >
                                                ...
                                                <div className="grid grid-cols-1 col-span-2 gap-4 md:grid-cols-3">
                                                    <Input
                                                        ...
                                                        Required={true}
                                                        Error={createErrors.receipt_date}
                                                        Value={createData.receipt_date}
                                                        Action={(e) =>
                                                            setCreateData(
                                                                'receipt_date',
                                                                e.target.value,
                                                    ...
                                                    <Input
                                                        InputName={'Received From'}
                                                        Id={'received_from'}
                                                        Name={'received_from'}
                                                        Type={'text'}
                                                        Placeholder={'Enter Received From'}
                                                        Required={false}
                                                        Error={createErrors.received_from}
                                                        Value={createData.received_from}
                                                        Action={(e) =>
                                                            setCreateData(
                                                                'received_from',
                                                                e.target.value,
                                                    ...
                                                    <div>
                                                        ...
                                                        <textarea
                                                            ...
                                                            value={createData.received_details}
                                                            onChange={(e) =>
                                                                setCreateData(
                                                                    'received_details',
                                                                    e.target.value,
                                                    ...
                                                    <SelectInput
                                                        InputName={'Recevied By'}
                                                        Id={'received_by'}
                                                        Name={'received_by'}
                                                        Error={createErrors.received_by}
                                                        Value={createData.received_by}
                                                        items={[{ name: 'cash' }, { name: 'bank' }]}
                                                        itemKey={'name'}
                                                        Placeholder={'Select Recevied By'}
                                                        Required={true}
                                                        Action={(value) => {
                                                            setCreateData('received_by', value);
                                                        }}
                                                    />

                                                    {/* Bank Details Section */}
                                                    {createData.received_by === 'bank' &&
                                                ...
                                                <div className="flex items-center justify-center col-span-2 gap-4 mt-4">
                                                    ...
                                                    <PrimaryButton
                                                        Type="submit"
                                                        Text="Save Receipt Voucher"
                                                        Spinner={createProcessing}
                                                        Disabled={
                                                            createProcessing ||
                                                            createData.receipt_date === '' ||
                                                            createData.received_by === '' ||
                                            ...
                                            >
                                                ...
                                                <div className="grid grid-cols-1 col-span-2 gap-4 md:grid-cols-3">
                                                    ...
                                                    <Input
                                                        ...
                                                        Placeholder={'Enter Received From'}
                                                        Required={false}
                                                        Error={editErrors.received_from}
                                                        Value={editData.received_from}
                                                        Action={(e) =>
                                                            setEditData(
                                                                'received_from',
                                                                e.target.value,
                                                    ...
                                                    <div>
                                                        ...
                                                        <textarea
                                                            ...
                                                            className="dark:bg-dark-900 shadow-theme-xs focus:ring-3 focus:outline-hidden mb-2 h-[42px] w-full min-w-0 max-w-full rounded-lg border border-gray-300 bg-transparent py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-blue-300 focus:ring-blue-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-blue-800"
                                                            placeholder="Enter Other Details here..."
                                                            value={editData.received_details ?? ''}
                                                            onChange={(e) =>
                                                                setEditData(
                                                                    'received_details',
                                                                    e.target.value,
                                                    ...
                                                    <SelectInput
                                                        ...
                                                        Id={'received_by'}
                                                        Name={'received_by'}
                                                        Error={editErrors.received_by}
                                                        Value={editData.received_by}
                                                        items={[{ name: 'cash' }, { name: 'bank' }]}
                                                        itemKey={'name'}
                                                        ...
                                                        Action={(value) => {
                                                            ...
                                                            setEditData('received_by', value);
                                                        }}
                                                    />

                                                    {/* Bank Details Section */}
                                                    {editData.received_by === 'bank' &&
                                                        bankDetails?.length > 0 && (
                                                            <>
                                                                <SelectInput
                                                                    InputName={'Select Bank Name'}
                                                ...
                                                <div className="flex items-center justify-center col-span-2 gap-4 mt-4">
                                                    ...
                                                    <PrimaryButton
                                                        Type="submit"
                                                        Text="Update Receipt Voucher"
                                                        Spinner={editProcessing}
                                                        Disabled={
                                                            editProcessing ||
                                                            editData.receipt_date === '' ||
                                                            editData.received_by === '' ||
                                                            editData.detail_id === '' ||
                                                            editData.currency_id === '' ||
                                                            editData.amount === '' ||
                        ...
                        <div className="relative z-10 w-full max-h-screen p-6 overflow-y-auto bg-white shadow-xl max-w-screen-2xl rounded-2xl dark:bg-gray-800 sm:p-8">
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                ...
                                <div>
                                    ...
                                    <div className="px-4 py-2 text-gray-800 bg-gray-100 rounded-md dark:bg-gray-700 dark:text-white">
                                        <p className="break-words">
                                            {viewData?.received_by || 'N/A'}
                                        </p>
                                    </div>
                                </div>

                                {viewData.received_by === 'bank' && (
                                    <>
                                        <div>
                                            <label className="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">
                                                Bank Name
