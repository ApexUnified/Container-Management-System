...
export default function index({ custom_clearances }) {
    const { props } = usePage();
    const {
    ...
    const CreateMethod = (e) => {
        ...
        createPost(route('setups.custom-clearances.store'), {
            onSuccess: () => {
    ...
    const EditMethod = (e) => {
        e.preventDefault();
        editPut(route('setups.custom-clearances.update', editData.id), {
            onSuccess: () => {
    ...
    return (
        <>
            <AuthenticatedLayout>
                <Head title="Setups - Custom Clearances" />

                <BreadCrumb
                    header={'Setups - Custom Clearances'}
                    parent={'Dashboard'}
                    parent_link={route('dashboard')}
                    child={'Setups - Custom Clearances'}
                />
                    ...
                    Content={
                        <>
                            ...
                            <Table
                                ...
                                BulkDeleteRoute={'setups.custom-clearances.destroybyselection'}
                                SingleDeleteRoute={'setups.custom-clearances.destroy'}
