...
export default function index({ shipping_lines }) {
    const { props } = usePage();
    const {
    ...
    const CreateMethod = (e) => {
        ...
        createPost(route('setups.shipping-lines.store'), {
            onSuccess: () => {
                setCreateData('name', '');
                setCreateData('email', '');
    ...
    const EditMethod = (e) => {
        e.preventDefault();
        editPut(route('setups.shipping-lines.update', editData.id), {
            onSuccess: () => {
    ...
    return (
        <>
            <AuthenticatedLayout>
                <Head title="Setups - Shipping Lines" />

                <BreadCrumb
                    header={'Setups - Shipping Lines'}
                    parent={'Dashboard'}
                    parent_link={route('dashboard')}
                    child={'Setups - Shipping Lines'}
                />
                    ...
                    Content={
                        <>
                            ...
                            <Table
                                ...
                                BulkDeleteRoute={'setups.shipping-lines.destroybyselection'}
                                SingleDeleteRoute={'setups.shipping-lines.destroy'}
