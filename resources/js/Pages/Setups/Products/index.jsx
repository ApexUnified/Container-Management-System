                                            ...
                                            >
                                                ...
                                                <div className="col-span-2 grid grid-cols-1 gap-4 md:grid-cols-3">
                                                    ...
                                                    <Input
                                                        ...
                                                        Required={false}
                                                        Error={createErrors.hs_code}
                                                        Value={createData.hs_code}
                                                        Action={(e) =>
                                                            setCreateData('hs_code', e.target.value)
                                                        }
                                                    />
                                            ...
                                            >
                                                ...
                                                <div className="col-span-2 grid grid-cols-1 gap-4 md:grid-cols-3">
                                                    ...
                                                    <Input
                                                        ...
                                                        Placeholder={'Enter HS Code'}
                                                        Required={false}
                                                        Error={editErrors.hs_code}
                                                        Value={editData.hs_code}
                                                        Action={(e) =>
                                                            setEditData('hs_code', e.target.value)
                                                        }
                                                    />
