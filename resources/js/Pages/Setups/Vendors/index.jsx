...
export default function index({ vendors }) {
    ...
    const CreateMethod = (e) => {
        ...
        createPost(route('setups.vendors.store'), {
            onSuccess: () => {
    ...
    const EditMethod = (e) => {
        e.preventDefault();
        editPut(route('setups.vendors.update', editData.id), {
            onSuccess: () => {
    ...
    return (
        <>
            <AuthenticatedLayout>
                <Head title="Setups - Vendors" />

                <BreadCrumb
                    header={'Setups - Vendors'}
                    parent={'Dashboard'}
                    parent_link={route('dashboard')}
                    child={'Setups - Vendors'}
                />
                    ...
                    Content={
                        <>
                            ...
                            <Table
                                ...
                                BulkDeleteRoute={'setups.vendors.destroybyselection'}
                                SingleDeleteRoute={'setups.vendors.destroy'}
                                items={vendors}
                                props={props}
                                columns={columns}
                                Search={false}
