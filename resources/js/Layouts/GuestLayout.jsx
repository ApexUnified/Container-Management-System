...
export default function GuestLayout({ children }) {
    ...
    // Background Image
    const [backgroundImage, setBackgroundImage] = useState(asset + 'assets/images/bg/bg.webp');
    ...
    return (
        <>
            ...
            <div className="relative min-h-screen z-1">
                <div
                    className="absolute inset-0 transition-opacity duration-300 bg-center bg-no-repeat bg-cover"
                    style={{
                        backgroundImage: `url(${backgroundImage})`,
                        filter: darkMode ? 'brightness(0.6)' : 'brightness(1)',
                    }}
                    aria-hidden="true"
                />
                ...
                <div className="relative z-10">
                    <div className="relative flex flex-col justify-center w-full h-screen sm:p-0 lg:flex-row">
                        ...
                        <div className="fixed z-50 hidden bottom-6 right-6 sm:block">
                            <button
                                className="inline-flex items-center justify-center text-white transition-colors bg-blue-600 rounded-full hover:bg-brand-600 size-14"
                                onClick={() => {
