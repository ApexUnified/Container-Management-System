                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <li>
                                                <Link
                                                    href={route('setups.account-setting.index')}
                                                    className={`menu-dropdown-item group ${route().current() === 'setups.account-setting.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'}`}
                                                >
                                                    Account Setting
                                                </Link>
                                            </li>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <li>
                                                <Link
                                                    href={route(
                                                        'transactions.extra-charges-expense-transactions.index',
                                                    )}
                                                    className={`menu-dropdown-item group ${route().current() === 'transactions.extra-charges-expense-transactions.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'}`}
                                                >
                                                    Extra Charges
                                                </Link>
                                            </li>
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <li>
                                                <Link
                                                    href={route('reports.chart-of-accounts.index')}
                                                    className={`menu-dropdown-item group ${route().current() === 'reports.chart-of-accounts.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'}`}
                                                >
                                                    Chart Of Accounts
                                                </Link>
                                            </li>
