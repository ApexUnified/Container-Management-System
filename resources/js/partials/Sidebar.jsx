                            ...
                            <ul className="mb-6 flex flex-col gap-4">
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        >
                                            <li>
                                                <Link
                                                    href={route('transactions.stock-ins.index')}
                                                    className={`menu-dropdown-item group ${route().current() === 'transactions.stock-ins.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'}`}
                                                >
                                                    Stock In
                                                </Link>
                                            </li>
                                ...
                                <li>
                                    <Link
                                        ...
                                        className={`menu-item group ${route().current() === 'currencies.index' ? 'menu-item-active' : 'menu-item-inactive'}`}
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
