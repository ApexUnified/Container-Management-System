        ...
        $stockIns = StockIn::whereBetween('entry_date', [$from_date, $to_date])
            ...
            ->map(function ($stockin) {
                return [
                    ...
                    'freight_forwarder_name' => $stockin->freight_forwarder->account_code.' - '.$stockin->freight_forwarder->title,
                    'custom_clearance_name' => $stockin->custom_clearance->account_code.' - '.$stockin->custom_clearance->title,
                    'transporter_name' => $stockin->transporter->account_code.' - '.$stockin->transporter->title,
